...
public class ForecastParserTest {
    ...
    public void testNormalStringGetCityName() {
        ...
        assertEquals("Moscow", report.getCityName());
    }
    ...
    public void testNormalStringGetCountryCode() {
        ...
        Forecast report = new Forecast(null, null);
        JSONparser.parseJsonForForecast(json, report);
        assertEquals("200", report.getCountryCode());
    }
    ...
    public void testNormalStringGetCoordinates() {
        ...
        Forecast report = new Forecast(null, null);
        JSONparser.parseJsonForForecast(json, report);
        assertEquals("055.75:037.62", report.getCoordinates());
    }
    ...
    public void testNormalStringGetMaxTemp() {
        ...
        Forecast report = new Forecast(null, null);
        JSONparser.parseJsonForForecast(json, report);
        assertEquals(262.31, report.getMaximumTemperature());
    }
    ...
    public void testNoNameInStringGetCityName() {
        String json = "{\"cod\":\"200\",\"message\":0.0036,\"cnt\":40,\"list\":[{\"dt\":1485799200,\"main\":{" +
                ...
                "\"description\":\"light snow\",\"icon\":\"13d\"}],\"clouds\":{\"all\":88},\"wind\":{\"speed\":4.1," +
                "\"deg\":249.006},\"snow\":{\"3h\":0.535},\"sys\":{\"pod\":\"d\"},\"dt_txt\":\"2017-01-31 09:00:00\"}," +
                "\"city\":{\"id\":524901,\"coord\":{\"lat\":55.7522,\"lon\":37.6156}," +
                "\"country\":\"none\"}}";
        Forecast report = new Forecast(null, null);
        JSONparser.parseJsonForForecast(json, report);
    ...
    @Test
    public void testNoNameInStringIsInConstructorGetCityName() {
        String json = "{\"cod\":\"200\",\"message\":0.0036,\"cnt\":40,\"list\":[{\"dt\":1485799200,\"main\":{" +
                "\"temp\":261.45,\"temp_min\":259.086,\"temp_max\":261.45,\"pressure\":1023.48,\"sea_level" +
                "\":1045.39,\"grnd_level\":1023.48,\"humidity\":79,\"temp_kf\":2.37},\"weather\":[{\"id\":800," +
                "\"main\":\"Clear\",\"description\":\"clear sky\",\"icon\":\"02n\"}],\"clouds\":{\"all\":8}," +
                ...
                "\"city\":{\"id\":524901,\"coord\":{\"lat\":55.7522,\"lon\":37.6156}," +
                "\"country\":\"none\"}}";
        Forecast report = new Forecast("Moscow", null);
        JSONparser.parseJsonForForecast(json, report);
        assertEquals("Moscow", report.getCityName());
    }

    @Test
    public void testNoCodeInStringGetCountryCode() {
        String json = "{\"message\":0.0036,\"cnt\":40,\"list\":[{\"dt\":1485799200,\"main\":{" +
                "\"temp\":261.45,\"temp_min\":259.086,\"temp_max\":261.45,\"pressure\":1023.48,\"sea_level" +
                "\":1045.39,\"grnd_level\":1023.48,\"humidity\":79,\"temp_kf\":2.37},\"weather\":[{\"id\":800," +
                "\"main\":\"Clear\",\"description\":\"clear sky\",\"icon\":\"02n\"}],\"clouds\":{\"all\":8}," +
                "\"wind\":{\"speed\":4.77,\"deg\":232.505},\"snow\":{},\"sys\":{\"pod\":\"n\"},\"dt_txt\":" +
    ...
    @Test
    public void testNoCodeInStringIsInConstructorGetCountryCode() {
        String json = "{\"message\":0.0036,\"cnt\":40,\"list\":[{\"dt\":1485799200,\"main\":{" +
                "\"temp\":261.45,\"temp_min\":259.086,\"temp_max\":261.45,\"pressure\":1023.48,\"sea_level" +
                "\":1045.39,\"grnd_level\":1023.48,\"humidity\":79,\"temp_kf\":2.37},\"weather\":[{\"id\":800," +
                "\"main\":\"Clear\",\"description\":\"clear sky\",\"icon\":\"02n\"}],\"clouds\":{\"all\":8}," +
                ...
                "\"city\":{\"id\":524901,\"name\":\"Moscow\",\"coord\":{\"lat\":55.7522,\"lon\":37.6156}," +
                "\"country\":\"none\"}}";
        Forecast report = new Forecast(null, "200");
        JSONparser.parseJsonForForecast(json, report);
        assertEquals("200", report.getCountryCode());
    }

    @Test
    public void testNoCoorInStringGetCoordinates() {
        String json = "{\"cod\":\"200\",\"message\":0.0036,\"cnt\":40,\"list\":[{\"dt\":1485799200,\"main\":{" +
                "\"temp\":261.45,\"temp_min\":259.086,\"temp_max\":261.45,\"pressure\":1023.48,\"sea_level" +
                "\":1045.39,\"grnd_level\":1023.48,\"humidity\":79,\"temp_kf\":2.37},\"weather\":[{\"id\":800," +
                "\"main\":\"Clear\",\"description\":\"clear sky\",\"icon\":\"02n\"}],\"clouds\":{\"all\":8}," +
    ...
    @Test
    public void testNoTemperatureInStringGetMinTemp() {
        String json = "{\"cod\":\"200\",\"message\":0.0036,\"cnt\":40," +
                "\"city\":{\"id\":524901,\"coord\":{\"lat\":55.7522,\"lon\":37.6156}," +
                "\"country\":\"none\"}}";
        Forecast report = new Forecast("Moscow", null);
        JSONparser.parseJsonForForecast(json, report);
        assertEquals(0, report.getMinimumTemperature());
    }

    @Test
    public void testNoTemperatureInStringGetMaxTemp() {
        String json = "{\"cod\":\"200\",\"message\":0.0036,\"cnt\":40," +
                "\"city\":{\"id\":524901,\"coord\":{\"lat\":55.7522,\"lon\":37.6156}," +
                "\"country\":\"none\"}}";
        Forecast report = new Forecast("Moscow", null);
        JSONparser.parseJsonForForecast(json, report);
        assertEquals(0, report.getMaximumTemperature());
    }

    @Test
    public void testIfStringToParseIsNull() {
        String json = null;
        Forecast report = new Forecast(null, null);
        try {
            JSONparser.parseJsonForForecast(json, report);
    ...
    @Test
    public void testIfStringToParseIsEmptyGetCoordinates() {
        Forecast report = new Forecast(null, null);
        JSONparser.parseJsonForForecast("", report);
        assertNull(report.getCoordinates());
    }

    @Test
    public void testIfStringToParseIsEmptyGetMinTemp() {
        Forecast report = new Forecast(null, null);
        JSONparser.parseJsonForForecast("", report);
    ...
    @Test
    public void testIfStringToParseIsEmptyGetMaxTemp() {
        Forecast report = new Forecast(null, null);
        JSONparser.parseJsonForForecast("", report);
